...
class Pick_Place:
    def __init__(self):
        ...
        self._grasp_object_width = rospy.get_param('~grasp_object_width', 0.099)
        ...
        # .position.x(or y z) - a, places the object away from the initial position (xyz) by 'a'
        self._pose_place = Pose()

        self._pose_place.position.x = self._pose_coke_can.position.x - 0.3
    ...
    def _add_table(self, name):
        ...
        self._scene.add_box(name, p, (0.5, 0.4, 0.85))
    ...
    def _add_grasp_block_(self, name):
        ...
        self._scene.add_box(name, p, (0.025, 0.099, 0.08))
        return p.pose
